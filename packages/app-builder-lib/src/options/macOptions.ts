...
export interface MacConfiguration extends PlatformSpecificBuildOptions {
   ...
   */
  readonly deskgapLanguages?: string[] | string;
   ...
   */
  readonly extraDistFiles?: string[] | string | null;
   ...
   */
  readonly target?: (MacOsTargetName | TargetConfiguration)[] | MacOsTargetName | TargetConfiguration | null;
