...
export interface SnapOptions extends CommonLinuxOptions, TargetSpecificOptions {
   ...
   */
  readonly assumes?: string[] | string | null;
   ...
   */
  readonly buildPackages?: string[] | null;
  /**
   ...
   * ```
   */
  readonly plugs?: (string | PlugDescriptor)[] | PlugDescriptor | null;
   ...
   */
  readonly stagePackages?: string[] | null;
