...
export interface LinuxConfiguration extends CommonLinuxOptions, PlatformSpecificBuildOptions {
   ...
   *
   * deskgap-builder [docker image](/multi-platform-build#docker) can be used to build Linux targets on any platform.
   *
...
export interface CommonLinuxOptions {
   ...
   */
  readonly executableArgs?: string[] | null;
