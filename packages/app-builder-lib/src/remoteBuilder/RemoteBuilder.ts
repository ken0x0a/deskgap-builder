...
export class RemoteBuilder {
  ...
  private async _build(targets: TargetInfo[], packager: PlatformPackager<any>): Promise<void> {
    ...
    if (result.error != null)
      throw new InvalidConfigurationError(
        `Remote builder error (if you think that it is not your application misconfiguration issue, please file issue to https://github.com/deskgap-userland/deskgap-builder/issues):\n\n${result.error}`,
